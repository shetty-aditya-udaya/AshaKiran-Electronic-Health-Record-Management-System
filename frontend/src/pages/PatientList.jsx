        ...
        <div className="flex flex-col md:flex-row md:items-center gap-3 w-full md:w-auto">
          ...
          <div className="relative group w-full md:w-auto">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 bg-white border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-primary/20 text-sm w-full md:w-80 transition-all outline-none font-body"
            />
          </div>
          ...
          <div className="flex items-stretch gap-3 w-full md:w-auto">
            {/* Sync Patients */}
            <div className="flex-1 md:flex-none flex flex-col items-stretch md:items-end gap-1">
              <button
            ...
            <button
              ...
              className="flex-1 md:flex-none h-11 flex items-center justify-center gap-2 bg-primary text-on-primary px-4 rounded-xl font-body font-semibold shadow-lg hover:opacity-90 active:scale-95 transition-all text-xs sm:text-sm whitespace-nowrap"
            >
